...
const [progress, setProgress] = useState(0)
  ...
  // setProgress=(progress)=>{  no required  because in functional component setprogress is already there
      ...
      <div>
       ...
       />
            ...
            <Switch>
                 ...
                 <Route exact path="/business"> <News  setProgress={setProgress}  apikey={apiKey}  key="businesss" pageSize={12} country="in" category="business"/></Route>
